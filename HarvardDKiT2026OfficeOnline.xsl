      ...
      <xsl:when test="b:StyleNameLocalized">
        <xsl:choose>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1033'">
            <xsl:text>Harvard-DKiT-2026</xsl:text>
          </xsl:when>
          ...
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1081'">
            <xsl:text>हार्वर्ड-DKiT-2026</xsl:text>
          </xsl:when>
          ...
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1063'">
            <xsl:text>Hārvarda-DKiT-2026</xsl:text>
          </xsl:when>
          ...
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1058'">
            <xsl:text>Гарвард-ДКіТ-2026</xsl:text>
          </xsl:when>
          ...
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1087'">
            <xsl:text>Гарвард-DKiT-2026</xsl:text>
          </xsl:when>
