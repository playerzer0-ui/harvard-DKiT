...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt"
      ...
      <xsl:when test="b:StyleNameLocalized">
        <xsl:choose>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1033'">
            <xsl:text>Harvard-DKiT-2024</xsl:text>
          </xsl:when>
          ...
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1081'">
            <xsl:text>हार्वर्ड-DKiT-2024</xsl:text>
          </xsl:when>
          ...
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1063'">
            <xsl:text>Hārvarda-DKiT-2024</xsl:text>
          </xsl:when>
          ...
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1058'">
            <xsl:text>Гарвард-ДКіТ-2024</xsl:text>
          </xsl:when>
          ...
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1087'">
            <xsl:text>Гарвард-DKiT-2024</xsl:text>
          </xsl:when>
	...
	<xsl:template name ="BibDisplayStrOnlineArticle">
		<xsl:variable name="cURL">
			<xsl:value-of select="count(b:URL)"/>
		</xsl:variable>
		<xsl:variable name="cYearAccessed">
			...
			<xsl:choose>
				...
				<xsl:when test="$SourceType = 'JournalArticle'">
					<xsl:element name="p">
						...
						<xsl:call-template name ="BibDisplayStrOnlineArticle"/>
						<xsl:call-template name ="templ_prop_Space"/>
